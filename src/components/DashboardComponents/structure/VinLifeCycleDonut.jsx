...
const VinLifeCycleDonut = () => {
  ...
  return (
    <div>
      <Card className="shadow-d radius-12 main-card-color">
        <Flex className="pb-2">
          <ModuleTopHeading level={4} name={t("VIN Lifecycle Status")} />
        </Flex>
                  ...
                  .map((item, index) => (
                    <Flex gap={5} align="center" className="mb-3" key={index}>
                      <img
                        ...
                        fetchPriority="high"
                      />
                      <Text className="fs-16 fw-500 text-white">
                        {isArabic
