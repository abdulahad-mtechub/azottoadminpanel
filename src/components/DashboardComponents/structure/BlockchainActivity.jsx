...
const BlockchainActivity = () => {
  ...
  return (
    <Card className="radius-12 main-card-color">
      <Flex justify="space-between" align="center" wrap gap={10}>
        <Flex vertical gap={3}>
          <ModuleTopHeading className="" level={4} name={t("Blockchain Activity")} />
